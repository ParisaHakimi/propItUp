...
function App() {
  return (
    <div className="App">
      ...
      <PersonCard namee="Smith, Maria" initialAge="62" hairColor="Brown"/>
      <PersonCard namee="Fillmore, Millard" initialAge="50" hairColor="Brown"/>
      <PersonCard namee="Doe, Jane" initialAge="45" hairColor="Black"/>
    </div>
  );
}
